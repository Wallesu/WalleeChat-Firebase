<template>
    <div class="emojiPicker">
        ...
        <div v-if="showEmojis" class="emojiPicker-container">
            <div class="emojiPicker-container-emoji">
                <Picker
                    class="emoji-mart"
                    :data="emojiData"
                    @select="emitEmoji"
...
.emojiPicker {
    ...
    &-container {
        ...
        height: auto;
        position: absolute;
        box-shadow: 5px 5px 5px 1px rgba(0, 0, 0, 0.150);
    }
